...
echo "10. ALERT_EMAIL_ADDRESS: The email address to receive monitoring alerts"
echo "11. ${ENVIRONMENT^^}_VERCEL_PROJECT_ID: Your Vercel project ID for frontend deployments"
echo -e "\nYou can populate most of these automatically by running: ./scripts/gh_populate_secrets.sh"
echo -e "For a clean run, ensure you have configured alert_email_address in your tfvars file."
