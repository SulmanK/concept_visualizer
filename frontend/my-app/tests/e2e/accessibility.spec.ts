...
test.describe('Accessibility', () => {
  test('home page should not have accessibility violations', async ({ page, mockApi }) => {
    await page.goto('/');
  ...
  test('concept generation page should not have accessibility violations', async ({ page, mockApi }) => {
  ...
  test('concept refinement page should not have accessibility violations', async ({ page, mockApi, mockLocalStorage }) => {
  ...
  test('form elements should have proper labels and ARIA attributes', async ({ page }) => {
    await page.goto('/create');
    ...
    for (const input of inputs) {
      ...
      if (id) {
        ...
        expect(label, `Input with ID ${id} should have an associated label`).toBeGreaterThan(0);
      } else {
