  ...
  function Qn(r) {
    return r.mode & 1
      ? we & 2 && et !== 0
        ...
        ? (nl === 0 && (nl = ld()), nl)
        : ((r = ke),
          r !== 0 || ((r = window.event), (r = r === void 0 ? 16 : gd(r.type))),
          r)
      : 1;
  }
  function en(r, i, a, f) {
    ...
    switch (n) {
      case "default":
        return o.hasText !== void 0
          ? `locator(${this.quote(s)}, { hasText: ${this.toHasText(
              o.hasText,
            )} })`
          : o.hasNotText !== void 0
          ? `locator(${this.quote(s)}, { hasNotText: ${this.toHasText(
              o.hasNotText,
            )} })`
...
class J1 {
    ...
    switch (n) {
      case "default":
        return o.hasText !== void 0
          ...
          : o.hasNotText !== void 0
          ? `locator(${this.quote(s)}, has_not_text=${this.toHasText(
              o.hasNotText,
            )})`
          : `locator(${this.quote(s)})`;
      case "frame-locator":
  ...
  regexToString(e) {
    ...
    return `re.compile(r"${ea(e.source)
      .replace(/\\\//, "/")
      .replace(/"/g, '\\"')}"${n})`;
  }
  toCallWithExact(e, n, s) {
    ...
    switch (n) {
      case "default":
        return o.hasText !== void 0
          ? `locator(${this.quote(
              s,
            )}, new ${l}.LocatorOptions().setHasText(${this.toHasText(
              o.hasText,
            )}))`
          : o.hasNotText !== void 0
          ? `locator(${this.quote(
              s,
            )}, new ${l}.LocatorOptions().setHasNotText(${this.toHasText(
              o.hasNotText,
            )}))`
          : `locator(${this.quote(s)})`;
      case "frame-locator":
      ...
      case "last":
        return "last()";
      case "visible":
        return `filter(new ${l}.FilterOptions().setVisible(${
          s === "true" ? "true" : "false"
        }))`;
      case "role":
        const c = [];
      ...
      case "has-text":
        return `filter(new ${l}.FilterOptions().setHasText(${this.toHasText(
          s,
        )}))`;
      case "has-not-text":
        return `filter(new ${l}.FilterOptions().setHasNotText(${this.toHasText(
          s,
        )}))`;
      case "has":
    ...
    switch (n) {
      case "default":
        return o.hasText !== void 0
          ...
          : o.hasNotText !== void 0
          ? `Locator(${this.quote(s)}, new() { ${this.toHasNotText(
              o.hasNotText,
            )} })`
          : `Locator(${this.quote(s)})`;
      case "frame-locator":
...
class a_ {
  generatePlaywrightRequestCall(e, n) {
    ...
    ["delete", "get", "head", "post", "put", "patch"].includes(c) ||
      ...
      s.searchParams.size &&
        l.push(
          `params=${this.prettyPrintObject(
            Object.fromEntries(s.searchParams.entries()),
          )}`,
        ),
...
class u_ {
  generatePlaywrightRequestCall(e, n) {
    ...
    for (const u of e.headers)
      l.push(
        `setHeader(${this.stringLiteral(u.name)}, ${this.stringLiteral(
          u.value,
        )})`,
      );
    return (
...
function kk(t, e) {
  ...
  for (const s of t)
    switch (s.name) {
      ...
      default:
        throw new Error(
          `Unknown attribute "${s.name}", must be one of ${Iy.map(
            (o) => `"${o}"`,
          ).join(", ")}.`,
        );
    }
...
function Xk(t, e, n) {
  ...
  if (e.nodeName === "IFRAME") {
    for (const c of ["name", "title"])
      e.getAttribute(c) &&
        s.push({
          engine: "css",
          selector: `${Ht(e.nodeName.toLowerCase())}[${c}=${Ci(
            e.getAttribute(c),
          )}]`,
          score: Rk,
        });
    return (
      e.getAttribute(n.testIdAttributeName) &&
        s.push({
          engine: "css",
          selector: `[${n.testIdAttributeName}=${Ci(
            e.getAttribute(n.testIdAttributeName),
          )}]`,
          score: _m,
        }),
  ...
  if (
    (e.getAttribute(n.testIdAttributeName) &&
      s.push({
        ...
        selector: `[${n.testIdAttributeName}=${ht(
          e.getAttribute(n.testIdAttributeName),
          !0,
        )}]`,
        score: _m,
  ...
  return (
    ...
    e.getAttribute("name") &&
      ...
      s.push({
        engine: "css",
        selector: `${Ht(e.nodeName.toLowerCase())}[name=${Ci(
          e.getAttribute("name"),
        )}]`,
        score: ku,
      }),
    ["INPUT", "TEXTAREA"].includes(e.nodeName) &&
      ...
      s.push({
        engine: "css",
        selector: `${Ht(e.nodeName.toLowerCase())}[type=${Ci(
          e.getAttribute("type"),
        )}]`,
        score: ku,
      }),
  ...
  strictModeViolationError(e, n) {
    ...
    return (
      s.length < n.length &&
        o.push(`
    ...`),
      this.createStacklessError(`strict mode violation: ${nr(
        this._sdkLanguage,
        Nn(e),
