...
describe("Card Component", () => {
  ...
  test("has hover effect with shadow by default", () => {
    const { container } = render(<Card>Card with hover effect</Card>);
  ...
  test("includes transition for animations", () => {
    const { container } = render(<Card>Card with transition</Card>);
  ...
  test("has hover translate effect", () => {
    const { container } = render(<Card>Card with hover translate</Card>);
