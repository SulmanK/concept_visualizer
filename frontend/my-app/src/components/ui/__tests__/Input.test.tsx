...
describe('Input Component', () => {
  ...
  test('adds required attribute when isRequired is true', () => {
    render(<Input label="Email" name="email" isRequired />);
  ...
  test('disables input when isDisabled is true', () => {
    render(<Input label="Username" name="username" isDisabled />);
  ...
  test('renders full width input when fullWidth is true', () => {
    ...
    const inputContainer = screen.getByLabelText('Username').parentElement;
