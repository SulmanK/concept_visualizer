...
describe("ErrorMessage Component", () => {
  ...
  test("renders error message correctly", () => {
    render(<ErrorMessage message="Test error message" type="generic" />);
  ...
  test("applies correct styling based on error type", () => {
    const { container, rerender } = render(
      <ErrorMessage message="Network error" type="network" />,
    );
    ...
    rerender(<ErrorMessage message="Permission error" type="permission" />);
  ...
  test("displays rate limit for specific category", () => {
    ...
    expect(
      screen.getByText(/Please try again next month/i),
    ).toBeInTheDocument();
...
describe("RateLimitErrorMessage Component", () => {
  test("correctly renders from ErrorWithCategory object", () => {
    ...
    render(<RateLimitErrorMessage error={rateLimitError} />);

    // Check component renders correctly
    expect(
      screen.getByText("Rate limit exceeded for concept generation"),
    ).toBeInTheDocument();
