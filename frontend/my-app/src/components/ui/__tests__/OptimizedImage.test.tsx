...
describe('OptimizedImage', () => {
  ...
  it('renders with custom class name', () => {
    ...
    render(<OptimizedImage src="/test-image.jpg" alt="Test Image" className={customClass} />);
  ...
  it('renders custom placeholder while image is loading', () => {
    ...
    expect(screen.queryByAltText('Loading placeholder')).not.toBeInTheDocument();
  });
  ...
  it('applies custom backgroundColor', () => {
    ...
    expect(['#ff0000', 'rgb(255, 0, 0)', '#f00'].includes(containerBgColor)).toBe(true);
  });
