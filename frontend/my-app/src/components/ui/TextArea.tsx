...
export const TextArea: React.FC<TextAreaProps> = ({
  ...
  const textareaBaseClasses = 'w-full px-4 py-3 rounded-lg border focus:outline-none resize-y';
  ...
  const textareaClasses = `${textareaBaseClasses} ${focusRingClasses} ${textareaErrorClasses} ${transitionClasses} ${animationClasses} ${className}`.trim();
