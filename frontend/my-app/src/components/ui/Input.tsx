...
export const Input: React.FC<InputProps> = ({
  ...
  const inputIconClasses = [startIcon ? "pl-10" : "", endIcon ? "pr-10" : ""]
    .join(" ")
    .trim();
  ...
  const inputClasses =
    `${inputBaseClasses} ${focusRingClasses} ${inputErrorClasses} ${inputIconClasses} ${transitionClasses} ${animationClasses} ${className}`.trim();
