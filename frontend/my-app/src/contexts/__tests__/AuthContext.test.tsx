...
describe('AuthContext', () => {
  ...
  describe('AuthProvider', () => {
    ...
    it('should set up auth state change listener', async () => {
      ...
      await waitFor(() => {
        expect(supabaseClient.supabase.auth.onAuthStateChange).toHaveBeenCalledTimes(1);
      });
    });
    ...
    it('should update state when session is available', async () => {
      ...
      vi.mocked(supabaseClient.initializeAnonymousAuth).mockResolvedValue(mockSession);
      ...
      expect(screen.getByTestId('auth-user').textContent).toBe(mockSession.user.id);
  ...
  describe('Auth State Changes', () => {
    it('should handle SIGNED_IN event', async () => {
      ...
      vi.mocked(supabaseClient.initializeAnonymousAuth).mockResolvedValue(anonymousSession);
      ...
      const onAuthStateChange = vi.mocked(supabaseClient.supabase.auth.onAuthStateChange).mock.calls[0][0];
    ...
    it('should handle SIGNED_OUT event', async () => {
      ...
      vi.mocked(supabaseClient.initializeAnonymousAuth).mockResolvedValue(initialSession);
  ...
  describe('Auth Actions', () => {
    ...
    it('should call linkEmail function', async () => {
      ...
      vi.mocked(supabaseClient.linkEmailToAnonymousUser).mockResolvedValue(true);
      ...
      expect(supabaseClient.linkEmailToAnonymousUser).toHaveBeenCalledWith('test@example.com');
    });
  });
