...
export const HowItWorks: React.FC<HowItWorksProps> = ({
  ...
  return (
    <div className="bg-white/90 backdrop-blur-sm rounded-lg shadow-modern border border-indigo-100 p-4 sm:p-6 md:p-8 mb-8 sm:mb-12">
      <h2 className="text-xl sm:text-2xl font-bold text-indigo-900 mb-8 sm:mb-16 text-center sm:text-left">
        How It Works
      </h2>
        ...
        {steps.map((step) => (
          <div key={step.number} className="relative z-10 group">
            <div className="transition-all duration-300 p-4 sm:p-5 rounded-lg hover:shadow-md bg-white border border-indigo-50 flex flex-col items-center">
              ...
              <h3 className="text-base sm:text-lg font-semibold text-indigo-900 mt-4 sm:mt-5 mb-2 sm:mb-3 text-center">
                {step.title}
              </h3>
              ...
              <p className="text-sm sm:text-base text-indigo-800 leading-relaxed text-center px-1 sm:px-2">
                {step.description}
              </p>
            </div>
          </div>
