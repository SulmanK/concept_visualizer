...
describe('ConceptDetailPage Component', () => {
  ...
  test('renders loading state initially', () => {
    ...
    render(withRoutesWrapper(['/concepts/test-123'], '/concepts/:conceptId', <ConceptDetailPage />));
  ...
  test('renders error state when there is an error', () => {
    ...
    expect(screen.getByText('Error loading concept details')).toBeInTheDocument();
  });
}); 