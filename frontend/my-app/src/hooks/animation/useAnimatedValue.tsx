...
export const useAnimatedValue = (
  ...
  const valueRangeRef = useRef<{start: number, end: number}>({ start: startValue, end: endValue });
  ...
  useEffect(() => {
    ...
    const startAnimation = () => {
      ...
      const animateValue = (timestamp: number) => {
        ...
        const currentValue = valueRangeRef.current.start + 
          (valueRangeRef.current.end - valueRangeRef.current.start) * easedProgress;
  ...
  }, [endValue, isActive, duration, easing, delay, onComplete, prefersReducedMotion]);
