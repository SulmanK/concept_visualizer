...
export const useIsAnonymous = () => React.useContext(mockAuthContext).isAnonymous;
export const useAuthIsLoading = () => React.useContext(mockAuthContext).isLoading;
...
export function withRoutesWrapper(initialEntries = ['/'], routePath = '/', element: ReactElement) {
  const testQueryClient = createTestQueryClient();
