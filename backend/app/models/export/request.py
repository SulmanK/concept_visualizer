...
class ExportRequest(APIBaseModel):
    ...
    target_format: Literal["png", "jpg", "svg"] = Field(..., description="Target format for export")
    target_size: Literal["small", "medium", "large", "original"] = Field("original", description="Target size for export")
    ...
    def validate_image_identifier(cls, v: str) -> str:
    ...
    def validate_storage_bucket(cls, v: str) -> str:
