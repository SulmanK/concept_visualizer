...
async def apply_rate_limit(req: Request, endpoint: str, rate_limit: str, period: Optional[str] = None) -> Dict[str, Any]:
...
async def apply_multiple_rate_limits(req: Request, rate_limits: List[Dict[str, str]]) -> Dict[str, Any]:
    ...
    return {"enabled": True, "limited": False, "checked_limits": results}
