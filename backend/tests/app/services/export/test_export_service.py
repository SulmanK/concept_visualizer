...
from app.services.export.service import ExportError, ExportService
...
class TestExportService:
    ...
    @pytest.fixture
    def export_service(self, mock_image_service: AsyncMock, mock_processing_service: AsyncMock) -> ExportService:
        """Create an ExportService with mocked dependencies."""
        return ExportService(image_service=mock_image_service, processing_service=mock_processing_service)

    @pytest.mark.asyncio
    async def test_process_export_png(self, export_service: ExportService, mock_processing_service: AsyncMock) -> None:
        """Test exporting an image to PNG with a specific size."""
        # Test data
        image_data = b"test_image_data"
        original_filename = "test_image.jpg"
        target_format: Literal["png", "jpg", "svg"] = "png"
        target_size: Literal["small", "medium", "large", "original"] = "medium"  # 1000x1000 as defined in the service
        ...
        mock_processing_service.convert_to_format.assert_called_once_with(b"processed_image_data", target_format="png", quality=95)
    ...
    @pytest.mark.asyncio
    async def test_process_export_jpg(self, export_service: ExportService, mock_processing_service: AsyncMock) -> None:
        """Test exporting an image to JPG with a specific size."""
        # Test data
        image_data = b"test_image_data"
        original_filename = "test_image.png"
        target_format: Literal["png", "jpg", "svg"] = "jpg"
        target_size: Literal["small", "medium", "large", "original"] = "small"  # 500x500 as defined in the service
        ...
        # Check that convert_to_format was called with the correct arguments
        mock_processing_service.convert_to_format.assert_called_once_with(b"processed_image_data", target_format="jpeg", quality=90)  # JPG is converted to JPEG internally
    ...
    @pytest.mark.asyncio
    async def test_process_export_original_size(self, export_service: ExportService, mock_processing_service: AsyncMock) -> None:
        """Test exporting an image with original size."""
        # Test data
        image_data = b"test_image_data"
        original_filename = "test_image.png"
        target_format: Literal["png", "jpg", "svg"] = "png"
        target_size: Literal["small", "medium", "large", "original"] = "original"
        ...
        mock_processing_service.convert_to_format.assert_called_once_with(b"test_image_data", target_format="png", quality=95)
    ...
    @patch("os.unlink")
    async def test_process_export_svg(self, mock_unlink: MagicMock, mock_tempfile: MagicMock, mock_image_open: MagicMock, export_service: ExportService) -> None:
        """Test exporting an image to SVG format."""
        # Test data
        image_data = b"test_image_data"
        original_filename = "test_image.png"
        target_format: Literal["png", "jpg", "svg"] = "svg"
        target_size: Literal["small", "medium", "large", "original"] = "original"
        svg_params: Dict[str, str] = {"mode": "color", "max_colors": 16}  # type: ignore
    ...
    @pytest.mark.asyncio
    async def test_process_export_error(self, export_service: ExportService, mock_processing_service: AsyncMock) -> None:
        """Test error handling in process_export."""
        # Test data
        image_data = b"test_image_data"
        original_filename = "test_image.png"
        target_format: Literal["png", "jpg", "svg"] = "png"
        target_size: Literal["small", "medium", "large", "original"] = "medium"
