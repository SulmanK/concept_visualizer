"""
Tests for the JigsawStackClient.

This module tests the JigsawStackClient which is responsible for
directly interacting with the JigsawStack API.
"""
...
class TestJigsawStackClient:
    ...
    @pytest.mark.asyncio
    async def test_generate_image_wide_aspect_ratio(self, client, mock_httpx_client):
    ...
    @pytest.mark.asyncio
    async def test_generate_image_tall_aspect_ratio(self, client, mock_httpx_client):
    ...
    @pytest.mark.asyncio
    async def test_generate_image_binary_response(self, client):
    ...
    @pytest.mark.asyncio
    async def test_generate_image_connect_error(self, client):
    ...
    @pytest.mark.asyncio
    async def test_generate_image_timeout(self, client):
    ...
    async def test_generate_image_api_error(self, client):
        ...
        with patch('app.core.exceptions.JigsawStackGenerationError.__str__', 
                  return_value="Image generation failed"):
            # Patch the httpx.AsyncClient to return our mock
            with patch('httpx.AsyncClient', return_value=mock_client):
                ...
                # Verify error details
                assert "Image generation failed" in str(excinfo.value)

    @pytest.mark.asyncio
    async def test_generate_image_json_decode_error(self, client):
    ...
    @pytest.mark.asyncio
    async def test_refine_image_success(self, client):
    ...
    @pytest.mark.asyncio
    async def test_generate_multiple_palettes_success(self, client):
        ...
        with patch('httpx.AsyncClient', return_value=mock_client):
            with patch.object(client, '_get_default_palettes', return_value=default_palettes):
                ...
                with patch.object(client, '_process_palette_colors') as mock_process:
                    def process_side_effect(palette):
                        return {
                            "name": palette["name"],
    ...
    @pytest.mark.asyncio
    async def test_generate_multiple_palettes_error_fallback(self, client):
    ...
    @pytest.mark.asyncio
    async def test_generate_image_with_palette_success(self, client):
    ...
    @pytest.mark.asyncio
    async def test_generate_image_connection_error(self, client):
    ...
    @pytest.mark.asyncio
    async def test_generate_image_auth_error(self, client):
