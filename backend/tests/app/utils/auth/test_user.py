...
from app.utils.auth.user import get_current_user, get_current_user_auth, get_current_user_id
...
class TestGetCurrentUserId:
    ...
    def test_get_current_user_id_from_state(self, mock_request: MagicMock) -> None:
    ...
    def test_get_current_user_id_state_empty_user(self, mock_request: MagicMock) -> None:
    ...
    def test_get_current_user_id_from_header(self, mock_decode_token: MagicMock, mock_request: MagicMock) -> None:
    ...
    @patch("app.utils.auth.user.decode_token")
    def test_get_current_user_id_invalid_token(self, mock_decode_token: MagicMock, mock_request: MagicMock) -> None:
    ...
    def test_get_current_user_id_from_session(self, mock_request: MagicMock) -> None:
    ...
    def test_get_current_user_id_no_user(self, mock_request: MagicMock) -> None:
...
class TestGetCurrentUserAuth:
    ...
    @patch("app.utils.auth.user.decode_token")
    def test_get_current_user_auth_valid(self, mock_decode_token: MagicMock) -> None:
    ...
    def test_get_current_user_auth_no_credentials(self) -> None:
        """Test with no credentials."""
        # Execute
        # Note: Typing indicates credentials should not be None, but we're testing error handling
        user_id = get_current_user_auth(None)  # type: ignore

        # Assert
        assert user_id is None

    @patch("app.utils.auth.user.decode_token")
    def test_get_current_user_auth_invalid_token(self, mock_decode_token: MagicMock) -> None:
    ...
    @patch("app.utils.auth.user.decode_token")
    def test_get_current_user_auth_missing_sub(self, mock_decode_token: MagicMock) -> None:
...
class TestGetCurrentUser:
    ...
    def test_get_current_user_with_id(self, mock_get_current_user_id: MagicMock, mock_request: MagicMock) -> None:
    ...
    @patch("app.utils.auth.user.get_current_user_id")
    def test_get_current_user_no_id(self, mock_get_current_user_id: MagicMock, mock_request: MagicMock) -> None:
