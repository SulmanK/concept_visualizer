...
from app.utils.logging.setup import is_health_check, setup_logging
...
class TestSetupLogging:
    ...
    def test_setup_logging_default_settings(self, mock_path: MagicMock, mock_rotating_handler: MagicMock, mock_stream_handler: MagicMock) -> None:
        ...
        with patch("app.utils.logging.setup.logging.getLogger", return_value=mock_root_logger), patch("app.utils.logging.setup.logging.Formatter", return_value=mock_formatter):
            # Execute
            setup_logging()
    ...
    @patch("app.utils.logging.setup.logging.StreamHandler")
    @patch("app.utils.logging.setup.Path")
    def test_setup_logging_create_log_dir(self, mock_path: MagicMock, mock_stream_handler: MagicMock) -> None:
        ...
        with patch("app.utils.logging.setup.logging.getLogger", return_value=mock_root_logger), patch("app.utils.logging.setup.logging.Formatter"):
            # Execute
            setup_logging()
    ...
    @patch("app.utils.logging.setup.logging.handlers.RotatingFileHandler")
    @patch("app.utils.logging.setup.Path")
    def test_setup_logging_custom_level(self, mock_path: MagicMock, mock_rotating_handler: MagicMock, mock_stream_handler: MagicMock) -> None:
    ...
    @patch("app.utils.logging.setup.logging.StreamHandler")
    @patch("app.utils.logging.setup.Path")
    def test_setup_logging_custom_format(self, mock_path: MagicMock, mock_stream_handler: MagicMock) -> None:
        ...
        with (
            patch("app.utils.logging.setup.logging.getLogger"),
    ...
    @patch("app.utils.logging.setup.logging.StreamHandler")
    @patch("app.utils.logging.setup.Path")
    def test_setup_logging_clear_existing_handlers(self, mock_path: MagicMock, mock_stream_handler: MagicMock) -> None:
        ...
        mock_root_logger.handlers = [
            mock_existing_handler1,
            mock_existing_handler2,
        ]  # Existing handlers

        with (
            patch("app.utils.logging.setup.logging.getLogger", return_value=mock_root_logger),
...
class TestIsHealthCheck:
    ...
    def test_is_health_check(self, path: str, expected: bool) -> None:
