...
from app.models.concept.response import ColorPalette, ConceptDetail, ConceptSummary, GenerationResponse, PaletteVariation, RefinementResponse
...
class TestPaletteVariation:
    ...
    def test_valid_variation(self) -> None:
    ...
    def test_minimal_variation(self) -> None:
        ...
        response = GenerationResponse(
            ...
            variations=[
                PaletteVariation(
                    ...
                    description=None,
                    image_url=HttpUrl("https://example.com/var1.png"),
                ),
                PaletteVariation(
                    palette_name="Green",
                    colors=["#00FF00", "#88FF88"],
                    description=None,
                    image_url=HttpUrl("https://example.com/var2.png"),
                ),
            ],
        )
...
class TestRefinementResponse:
    ...
    def test_valid_refinement(self) -> None:
        ...
        response = RefinementResponse(
            ...
            theme_description="Blue professional theme",
            created_at="2023-01-01T12:00:00Z",
            image_url=HttpUrl("https://example.com/refined.png"),
            original_image_url=HttpUrl("https://example.com/original.png"),
...
class TestConceptSummary:
    ...
    def test_refinement_summary(self) -> None:
...
class TestConceptDetail:
    ...
    def test_refinement_detail(self) -> None:
