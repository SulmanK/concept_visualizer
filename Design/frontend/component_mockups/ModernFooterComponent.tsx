      ...
      <div className="container max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="mt-10 pt-6 border-t border-indigo-700 text-center">
          ...
          <div className="mt-4 flex justify-center space-x-6">
            <Link to="/privacy" className="text-sm text-indigo-300 hover:text-white transition-colors">
              Privacy Policy
            </Link>
            <Link to="/terms" className="text-sm text-indigo-300 hover:text-white transition-colors">
              Terms of Service
            </Link>
            <Link to="/sitemap" className="text-sm text-indigo-300 hover:text-white transition-colors">
              Sitemap
            </Link>
          </div>
        </div>
